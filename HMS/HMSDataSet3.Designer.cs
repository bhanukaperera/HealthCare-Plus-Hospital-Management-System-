...
namespace HMS.HMSDataSet3TableAdapters {
...
SELECT DoctorID, FirstName, LastName, Gender, DateOfBirth, Email, PhoneNumber, Specialization, HouseNo, Street, City, Experience, Comments FROM DoctorDetails WHERE (DoctorID = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(HMSDataSet3.DoctorDetailsDataTable dataTable) {
        ...
        public virtual HMSDataSet3.DoctorDetailsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HMSDataSet3.DoctorDetailsDataTable dataTable = new HMSDataSet3.DoctorDetailsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HMSDataSet3.DoctorDetailsDataTable dataTable) {
